                                                ...
                                                <div class="text ">
                                                    ...
                                                    <div class="text-inner text-center">
                                                        ...
                                                        <div role="form" class="wpcf7" id="wpcf7-f43-p20-o1"
                                                            ...
                                                            <form action="lien-he/#wpcf7-f43-p20-o1" method="post"
                                                                ...
                                                                <div class="form-ct clear">
                                                                    ...
                                                                    <div class="form-row w50">
                                                                        <span
                                                                            class="wpcf7-form-control-wrap number-soluong"><input
                                                                                type="number" name="number-soluong"
                                                                                value=""
                                                                                class="wpcf7-form-control wpcf7-number wpcf7-validates-as-required wpcf7-validates-as-number form_lien_he_w50"
                                                                                id="number-soluong" min="1"
                                                                                aria-required="true" aria-invalid="false"
                                                                                placeholder="Số lượng" /></span>
                                                                    </div>
                                                                    <div class="form-row">
                                                                        <span
                                                                            class="wpcf7-form-control-wrap textarea-noidung">
                                                                            <textarea name="textarea-noidung" cols="40" rows="10"
                                                                                class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required form_lien_he" id="textarea-noidung"
                                                                                aria-required="true" aria-invalid="false" placeholder="Lời nhắn"></textarea>
                                                                        </span>
                                                                    </div>
